...
android {
    namespace = "com.example.zedpe"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.zedpe"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    dependencies {
        ...
        implementation(platform("androidx.compose:compose-bom:2024.04.01")) // Or latest BOM
        implementation("androidx.compose.ui:ui")
        implementation("androidx.compose.ui:ui-graphics")
        implementation("androidx.compose.ui:ui-tooling-preview")
        implementation("androidx.compose.material3:material3")
        // For icons if you want to use them
